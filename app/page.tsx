...
const decisionCards = [
  {
    ...
    body:
      "Most “it looked fine online” failures are payment-related: debit vs credit, name mismatch, deposit holds, and desk discretion.",
  ...
  },
  {
    ...
    body:
      "Daylight shrinks. Driving takes longer. Recovery options get fewer. If your plan needs perfect conditions, it’s not a plan.",
    href: "/getting-around-finland",
  ...
  },
  {
    ...
    body:
      "In Finland, “can you make an exception?” usually means “no”. So you win by verifying inputs, not by negotiating at the desk.",
    href: "/policy",
    cta: "How we verify",
  },
];
            ...
            <div className="relative">
              <div className="relative mx-auto max-w-[520px]">
                ...
                <p className="mt-3 text-xs text-white/70">
                  Practical hubs. No “ultimate guide” fluff, only decision points.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="flex items-end justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-600">
                      Start with the thing you’re most likely to mess up.
                    </p>
                  </div>
                  ...
                  <div className="relative mx-auto max-w-6xl pt-14 md:pt-16">
                    <div className="max-w-2xl rounded-3xl border border-white/15 bg-white/10 backdrop-blur-md p-6 md:p-8 text-white shadow-[0_18px_70px_rgba(0,0,0,0.35)]">
                      ...
                      <p className="mt-5 text-xs text-white/70">
                        No promises we can’t verify. No invented policy facts. Just the stuff that breaks first.
                      </p>
                    </div>
                  </div>
                </Section>
