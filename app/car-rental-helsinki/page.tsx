  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <div className="mx-auto max-w-6xl px-4 pb-12">
        ...
        <section className="mt-2 rounded-2xl border border-slate-200 bg-slate-50 p-6 shadow-sm">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div className="max-w-3xl">
              <div className="inline-flex items-center rounded-full bg-white/70 px-3 py-1 text-xs font-semibold text-slate-700 border border-slate-200">
        ...
        {/* Disclosure */}
        <section className="mt-12 rounded-2xl border border-slate-200 bg-slate-50 p-6 shadow-sm">
