...
/**
 * NO-404 MODE
 * - Most nincs meg a képkészlet, ezért 404 lenne mindenhol.
 * - Ha felraktad a képeket /public/images alá, állítsd true-ra.
 */
...
<svg xmlns="http://www.w3.org/2000/svg" width="1600" height="900" viewBox="0 0 1600 900">
  ...
  <rect x="80" y="80" width="1440" height="740" rx="32" fill="#ffffff" opacity="0.7"/>
  <g fill="#0f172a" opacity="0.55">
    <text x="140" y="210" font-family="ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto" font-size="46" font-weight="600">
      Image placeholder
    </text>
    <text x="140" y="270" font-family="ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto" font-size="24">
      Add your /public/images assets, then set IMAGES_ENABLED = true
    </text>
  </g>
  <g opacity="0.08">
    <circle cx="1260" cy="240" r="140" fill="#0f172a"/>
    <circle cx="1330" cy="310" r="90" fill="#0f172a"/>
    <circle cx="1180" cy="330" r="70" fill="#0f172a"/>
  </g>
</svg>
`);
...
function SafeImage(props: Omit<ImageProps, "src"> & { src?: string }) {
  const { src, alt, ...rest } = props;

  // Ha nincs kép készlet, ne kérjünk be nem létező fájlokat.
  const finalSrc = IMAGES_ENABLED && src ? src : PLACEHOLDER_SRC;

  return <Image {...rest} src={finalSrc} alt={alt} />;
}
  ...
  return (
    <div className="bg-white">
      <PageHero
        ...
        // Hero kép: külön hero path (nem OG). Ha nincs meg, placeholder lesz.
        imageSrc={
          IMAGES_ENABLED
            ? "/images/hero/hero-finland-winter-camper.jpg"
            : PLACEHOLDER_SRC
        }
      />
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_360px]">
            ...
            <div>
              ...
              <article className="prose prose-slate max-w-none px-0 py-10 prose-headings:tracking-tight prose-a:text-slate-900">
                ...
                <p>Cold hands. Clear head. Northern sky. That’s the deal.</p>

                <hr />

                <p className="text-sm text-slate-600">
                  <strong>Internal links:</strong>{" "}
                  <Link href="/blog/lapland-tours-2026">Lapland Tours 2026</Link> ·{" "}
                  <Link href="/blog/rovaniemi-unveiled-lapland-winter-guide-2026">
                    Rovaniemi Winter Guide 2026
                  </Link>{" "}
                  · <Link href="/blog/helsinki-winter-guide-2026">Helsinki Winter Guide 2026</Link>
                </p>
                <p className="text-sm text-slate-600">
            ...
            <aside className="lg:sticky lg:top-24 h-fit space-y-4">
              ...
              <Card className="overflow-hidden p-0">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4">
                    <CtaButton href="/get-help" variant="outline" className="w-full">
                      Get Help →
                    </CtaButton>
                  </div>
                </div>
