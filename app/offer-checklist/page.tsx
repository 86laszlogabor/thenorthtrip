          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row md:flex-col md:items-stretch">
              <Link
                ...
                className="rounded-lg bg-orange-600 px-5 py-3 text-center text-sm font-semibold text-white hover:bg-orange-500"
              >
                Car rental Helsinki
              </Link>
              <Link
                ...
                <ul className="mt-2 space-y-2 text-sm text-slate-700">
                  {it.checks.map((c) => (
                    <li key={c} className="flex gap-2">
                      <span className="mt-[2px] h-4 w-4 rounded border border-slate-300 bg-white" />
                      <span>{c}</span>
                    </li>
                  ))}
                </ul>
...
Cancellation:`}
          ...
          <div className="mt-4 text-xs text-slate-500">
            If you want, we can also generate a “car rental Helsinki” filled version once you paste real partner policy details.
          </div>
        </div>
      </section>
    </main>
