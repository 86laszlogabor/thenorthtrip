  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      <PageHero
        ...
        imageSrc="/images/hero/hero-partner-viator.jfif"
      ...
      <section className="mx-auto max-w-6xl px-4 py-10">
        ...
        <p className="mt-3 max-w-3xl text-slate-700">
          Viator is a marketplace. Your real risk is procedural: meeting points, cutoffs, transfers, and cancellation rules.
          Verify what is enforced and build buffer around it.
        </p>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
            <h2 className="font-semibold">Booking discipline</h2>
