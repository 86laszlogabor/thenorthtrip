...
const points: Point[] = [
  ...
  },
  {
    ...
    body:
      "This is not a busy hub where you can miss something and effortlessly swap to the next option. The upside is calm. The cost is recovery friction.",
      ...
      <Section>
        ...
        <div className="mt-10 grid gap-4 md:gap-6 md:grid-cols-2">
          ...
          <Card>
            ...
            <p className="mt-3 text-sm text-brand-text/70">
              Booking like a busy hub. Inari is better with fewer, higher-quality days and real buffers between them.
            </p>
          </Card>
        </div>
