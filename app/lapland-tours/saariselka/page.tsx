...
export const metadata = {
 title: "Saariselkä Tours | Lapland | TheNorthTrip",
 description:
 ...
 openGraph: {
 title: "Saariselkä Tours | TheNorthTrip",
 description:
 "Saariselkä base decisions: quieter Lapland routing, transport dependencies, and buffer-first planning so your schedule survives winter friction.",
...
const points = [
 ...
 body: "Saariselkä rewards planning. If you miss a start time, recovery options are usually fewer than in bigger Bases.",
 },
 {
...
export default function SaariselkaHubPage() {
 ...
 <p className="mt-3 text-sm text-brand-text/70">
 Booking like a busy. Saariselkä works best with fewer, higher-quality days and more slack.
 </p>
 </Card>
 </div>
