...
export const metadata = {
  title: "Ylläs tours | Lapland Tours | TheNorthTrip",
  description:
    "Ylläs as a Lapland base: a decision-first skeleton page for tours, season fit, and booking checks.",
};
    ...
    <div className="bg-white">
      <section className="mx-auto max-w-site px-4 py-12 md:py-16">
        ...
        <h1 className="mt-3 text-3xl md:text-5xl font-semibold tracking-tight">
          Ylläs: outdoors-first base and space to breathe
        </h1>
        ...
        <div className="mt-6 grid gap-4 md:gap-6 md:grid-cols-2 lg:grid-cols-3">
          <Card>
            ...
            <p className="mt-2 text-sm text-brand-text/70">
              Outdoor-heavy itineraries and less “resort noise”.
            </p>
          </Card>
          <Card>
            <h3 className="text-lg font-semibold">Tour types</h3>
            <p className="mt-2 text-sm text-brand-text/70">
              Snowshoe, aurora, winter nature, longer excursions.
            </p>
          </Card>
          <Card>
            <h3 className="text-lg font-semibold">What to confirm</h3>
            <p className="mt-2 text-sm text-brand-text/70">
              Transport/pickup, duration realism, clothing requirements.
            </p>
          </Card>
        </div>
