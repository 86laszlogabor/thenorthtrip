...
export const metadata = {
  title: "Helsinki Sauna Experiences | TheNorthTrip",
  description:
    "Sauna experiences in Helsinki: booking logic, rules, and what to confirm before you show up.",
};
    ...
    <div className="bg-white">
      <section className="mx-auto max-w-site px-4 py-12 md:py-16">
        ...
        <h1 className="mt-3 text-3xl md:text-5xl font-semibold tracking-tight">
          Sauna experiences: book it right, enjoy it quietly
        </h1>
        <p className="mt-4 text-base md:text-lg text-brand-text/75 max-w-2xl">
          Skeleton page. We’ll add verified sauna options later. For now: clean structure, no noise.
        </p>
        ...
        <div className="mt-6 grid gap-4 md:gap-6 md:grid-cols-2 lg:grid-cols-3">
          <Card className="flex flex-col">
            ...
            <p className="mt-2 text-sm text-brand-text/70">
              What changes in price, vibe, and booking friction.
            </p>
          ...
          <Card className="flex flex-col">
            ...
            <p className="mt-2 text-sm text-brand-text/70">
              Time slots, cancellation windows, and peak-hour reality.
            </p>
            <div className="mt-auto pt-4 text-sm text-brand-text/60">
              Placeholder. Coming after validation.
            </div>
          ...
          <Card className="flex flex-col">
            <h3 className="text-lg font-semibold">Etiquette (short version)</h3>
            <p className="mt-2 text-sm text-brand-text/70">
              What people expect, without turning it into a lecture.
            </p>
            <div className="mt-auto pt-4 text-sm text-brand-text/60">
              Placeholder. Coming after validation.
            </div>
