...
export const metadata = {
  title: "Helsinki sauna visits | TheNorthTrip",
  description: "Etiquette, booking rules, and what to confirm before you show up.",
};
    ...
    <div className="bg-white">
      <section className="mx-auto max-w-site px-4 py-12 md:py-16">
        <h1 className="text-3xl md:text-5xl font-semibold tracking-tight">
          Helsinki sauna visits
        </h1>
        <p className="mt-4 text-base md:text-lg text-brand-text/75 max-w-2xl">
          Etiquette, booking rules, and what to confirm before you show up.
        </p>
        <div className="mt-8">
