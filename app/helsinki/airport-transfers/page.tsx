...
export const metadata = {
  ...
  description: "Train vs taxi tradeoffs, luggage friction, and winter buffers. Verify tickets/zones and late-night options.",
};
    ...
    <div className="bg-white">
      <section className="mx-auto max-w-site px-4 py-12 md:py-16">
        ...
        <p className="mt-4 text-base md:text-lg text-brand-text/75 max-w-2xl">
          Train vs taxi tradeoffs, luggage friction, and winter buffers. Verify tickets/zones and late-night options.
        </p>
        <div className="mt-8">
