...
export const metadata = {
  ...
  description: "Walkable core, museums, and timing realities. Verify opening hours and seasonal closures.",
};
    ...
    <div className="bg-white">
      <section className="mx-auto max-w-site px-4 py-12 md:py-16">
        ...
        <p className="mt-4 text-base md:text-lg text-brand-text/75 max-w-2xl">
          Walkable core, museums, and timing realities. Verify opening hours and seasonal closures.
        </p>
        <div className="mt-8">
