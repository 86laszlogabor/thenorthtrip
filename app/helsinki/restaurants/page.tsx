...
export const metadata = {
  ...
  description: "Reservations, service rhythm, and expectations. Verify booking windows and dietary notes.",
};
    ...
    <div className="bg-white">
      <section className="mx-auto max-w-site px-4 py-12 md:py-16">
        ...
        <p className="mt-4 text-base md:text-lg text-brand-text/75 max-w-2xl">
          Reservations, service rhythm, and expectations. Verify booking windows and dietary notes.
        </p>
        <div className="mt-8">
