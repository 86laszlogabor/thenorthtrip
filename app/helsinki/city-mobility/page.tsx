...
export default function HelsinkiCityMobilityPage() {
 ...
 <Pill icon="???">Parking is the tax</Pill>
 <Pill icon="??">Pickup time counts</Pill>
 ...
 {decisionRows.map((r) => (<tr key={r.plan} className="border-b border-slate-200 last:border-b-0">
