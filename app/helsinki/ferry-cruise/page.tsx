...
export const metadata = {
  title: "Helsinki Ferry & Cruise | TheNorthTrip",
  description:
    "Ferries and cruises from Helsinki: what to book, what to confirm, and what depends on weather and timing.",
};
    ...
    <div className="bg-white">
      <section className="mx-auto max-w-site px-4 py-12 md:py-16">
        ...
        <h1 className="mt-3 text-3xl md:text-5xl font-semibold tracking-tight">
          Ferry & cruise: the simplest “wow per hour”
        </h1>
        <p className="mt-4 text-base md:text-lg text-brand-text/75 max-w-2xl">
          Skeleton page. Later we’ll add verified options and routes. For now we
          keep the structure clean and linkable.
        </p>
      ...
      <Section>
        ...
        <div className="mt-6 grid gap-4 md:gap-6 md:grid-cols-2 lg:grid-cols-3">
          <Card className="flex flex-col">
            <h3 className="text-lg font-semibold">Island ferries</h3>
            <p className="mt-2 text-sm text-brand-text/70">
              Short routes, easy planning, weather-aware timing.
            </p>
          ...
          <Card className="flex flex-col">
            <h3 className="text-lg font-semibold">Short cruises</h3>
            <p className="mt-2 text-sm text-brand-text/70">
              When a cruise makes sense, and when it’s just a time sink.
            </p>
            <div className="mt-auto pt-4 text-sm text-brand-text/60">
              Placeholder. Coming after validation.
            </div>
          ...
          <Card className="flex flex-col">
            ...
            <p className="mt-2 text-sm text-brand-text/70">
              Meeting point, cancellation window, and what happens in bad weather.
            </p>
            <div className="mt-auto pt-4 text-sm text-brand-text/60">
              Placeholder. Coming after validation.
            </div>
