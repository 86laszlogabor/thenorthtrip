...
function LogoFallback({ name }: { name: string }) {
 return (<div className="flex h-10 w-10 items-center justify-center rounded-lg bg-slate-100 text-sm font-semibold text-slate-700">
...
export default function PartnerStrip({
 ...
 return (<section className="mt-8 rounded-2xl border border-slate-200 bg-white p-5 md:p-6 shadow-sm">
 ...
 {p.newTab? (<a href={p.href} target="_blank" rel="noopener noreferrer">
 <CtaButton href={p.href} variant="success" full>
 {p.ctaLabel?? "Check options"}
 </CtaButton>
 </a>): (<CtaButton href={p.href} variant="success" full>
 {p.ctaLabel?? "Check options"}
 </CtaButton>)}
