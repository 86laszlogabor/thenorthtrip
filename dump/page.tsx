...
export const metadata = {
 openGraph: { images: ['/images/og/og-default.jpg'] },
...
export default function HomePage() {
 return (<main className="bg-white">{/* HERO */}
 ...
 Most √¢Ç¨≈ìbad deals√¢Ç¨ù are really bad assumptions. Here are the ones that
 keep showing up.
 </p>
 </div>
 ...
 description="Tyres, visibility, and local conditions matter more than the car model. Know what you√¢Ç¨Ñ¢re actually getting."
 ctaLabel="Check Availability"
 ctaHref="/car-rental-helsinki"
 highlighted
 />
 ...
 description="Focus on deductible, exclusions, and claim handling. √¢Ç¨≈ìInsurance included√¢Ç¨ù often hides the important parts."
 ctaLabel="Check Availability"
 ctaHref="/car-rental-helsinki"
 />
 </div>
